...
def get_vlnbert_models(args, config=None):
    if args.model == 'Vanilla-VLNBERT':
        ...
        model_class = VLNBert
        model_name_or_path = '/root/IROS2023/datasets/pretrained/Prevalent/pretrained_model/pytorch_model.bin'
        # model_name_or_path = '/home/xyz9911/PycharmProjects/igibson/datasets/pretrained/Prevalent/pretrained_model/pytorch_model.bin'
        ...
        model_name_or_path = '/root/IROS2023/datasets/pretrained/DUET/model_LXRT.pth'
        # model_name_or_path = '/home/xyz9911/PycharmProjects/igibson/datasets/pretrained/DUET/model_LXRT.pth'
        new_ckpt_weights = {}
        if model_name_or_path is not None:
            ...
            for param_name, param in ckpt_weights.items():
