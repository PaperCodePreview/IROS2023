...
from igibson.render.mesh_renderer.instances import Robot

import torch
import numpy as np
import os
import igibson
from igibson.utils.mesh_util import xyzw2wxyz, quat2rotmat
...
class VisionSensor(BaseSensor):
    ...
    def get_obs(self, env):
        ...
        """
        raw_vision_obs, label_vision_obs = self.get_render_results(env.simulator.renderer, modes=self.raw_modalities,
                                                                   need_label='label' in self.modalities)
